/// This shader file contains an implementation of SHA-256,
/// following the FIPS 180-4 specifaction.
/// It also contains some helper functions useful for
/// Bitcoin mining in particular.
...
fn doubleHash(blocks: array<u32, 32>) -> array<u32, 8> {
